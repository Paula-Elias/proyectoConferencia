...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.querySelector('#mapa')) {
        ...
        var map = L.map('mapa').setView([21.934691, -462.287736], 16);
        ...
        L.marker([21.934691, -462.287736]).addTo(map)

            .bindPopup('GDL WEBCAMP <br> Boletos disponibles')
